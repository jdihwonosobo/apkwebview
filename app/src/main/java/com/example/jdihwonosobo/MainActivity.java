package com.example.jdihwonosobo;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String myWebSite = "https://jdih.wonosobokab.go.id/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // load the website
        webView.loadUrl("https://jdih.wonosobokab.go.id/");
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == file_chooser_activity_code) {
            if (resultCode == Activity.RESULT_OK && data != null) {
                ...
                mUploadMessageArr = null;
                Toast.makeText(MainActivity.this, "Terjadi kesalahan saat mengambil file", Toast.LENGTH_LONG).show();
            }
        }
    }
...
//        // ==============================
        ...
        public void onReceivedError(WebView view, WebResourceRequest request, WebResourceError error) {
            ...
            progressDialog.dismiss();
            Toast.makeText(getApplicationContext(), "Periksa Internet! ", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public class myWebChromeClient extends WebChromeClient {
        ...
        public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> valueCallback, FileChooserParams fileChooserParams) {
            ...
            Intent chooserIntent = Intent.createChooser(intent, "Pilih file");
